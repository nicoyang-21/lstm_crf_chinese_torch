...
# Helper functions to make the code readable

def argmax(vec):
    """ :return the argmax as a python int"""
    _, idx = torch.argmax(vec, 1)
    return idx.item()
    ...
    def _forward_alg(self, feats):
        ...
        for feat in feats:
            ...
            for next_tag in range(self.target_size):
                ...
                next_tar_var = forward_var + trans_score + emit_score
                # The forward variable for this tag is log-sum-exp of all the
                # scores.
                alphas_t.append(log_sum_exp(next_tar_var).view(1))
...
if __name__ == '__main__':
    ...
    model = BiLSTM_CRF(len(word_to_ix), tag_to_ix, EMBEDDING, HIDDEN_DIM)
